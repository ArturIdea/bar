    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 bg-opacity-50">
      <div className="bg-white w-[450px] rounded-4xl p-6 shadow-lg">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="relative">
              ...
              <input
                ...
                readOnly
                className="focus:ring-0 w-full border border-gray-300 rounded-xl p-2 cursor-pointer"
              />
            </div>
          </div>
        </div>
        <div className="mt-6 flex justify-center items-center gap-3">
          <button
            type="button"
            className="border-2 border-[#08678e] text-gray-700 px-4 py-2 rounded-full cursor-pointer"
            onClick={onClose}
          >
            Cancel
          </button>
