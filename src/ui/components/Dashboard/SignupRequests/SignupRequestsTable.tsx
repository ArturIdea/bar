...
export const SignUpRequestsTable: React.FC = () => {
  const { requests, loading } = useSignUpRequests(0, 10);
          ...
          <tbody>
            {sortedRequests.map((req, index) => (
              ...
              >
                ...
                <td className="px-6 py-4 text-gray-600 text-sm">{req.phoneNumber}</td>
                <td className="px-6 py-4 text-gray-600 text-sm">{req.pinfl}</td>
                <td className="px-6 py-4 text-gray-600 text-sm">
